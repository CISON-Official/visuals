...
function nsa_registrations_table_shortcode($atts)
{
    ...
    <div class="u-nsa-container">
        <div class="u-nsa-controls">
            <div class="u-nsa-stats">
                Showing <strong><?php echo count($results); ?></strong> of <strong><?php echo $total_items; ?></strong>
                entries
            </div>

            <div class="u-nsa-actions">
                <form method="get" class="u-nsa-search-form">
                    <input type="text" name="s" value="<?php echo esc_attr($search); ?>" placeholder="Search records..."
                        class="u-nsa-input">
                ...
                <?php if ($filter_key): ?>
                    <form method="get" class="u-nsa-filter-form">
                        <select name="filter_<?php echo esc_attr($filter_key); ?>" onchange="this.form.submit()"
                            class="u-nsa-select">
            ...
            <table class="u-nsa-table">
                ...
                <tbody>
                    <?php if ($results):
                        ...
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="<?php echo count($columns) + 1; ?>" class="u-nsa-no-data">No records found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <style>
        ...
        .u-nsa-pagination .current {
            background: #3182ce;
            color: white;
            border-color: #3182ce;
        }

        .u-nsa-pagination .page-numbers:hover:not(.current) {
            background: #edf2f7;
        }
