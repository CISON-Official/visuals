...
function store_registration_form_session($checkout)
{
    if (!empty($_POST) && isset($_POST['member_id'])) {
        $form_data = array();
        $fields = array('member_id', 'registering_for', 'title', 'first_name', 'last_name', 'email', 'phone', 'occupation', 'organisation', 'street', 'city', 'state', 'postcode', 'country', 'gender', 'hear_about');
