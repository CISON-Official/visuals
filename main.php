...
require_once VISUALS_PATH . 'src/election/admin.php';
require_once VISUALS_PATH . 'src/election/results.php';
require_once VISUALS_PATH . 'src/examination/cison-member-portal.php';